...
export const workExperienceDetails: WorkExperienceDetails[] = [
  {
    ...
    reflection:
      'As a fullstack developer, I focus on building scalable and maintainable systems. I prioritize creating clean, flexible database designs and modular code to improve software quality and ease future development.',
    responsibilities: [
    ...
    projects: [
      {
        name: 'Event Equipment Rental Point of Sale',
        link: 'https://balisewasewa.com',
      },
      {
        name: 'Football Academy Management System',
        link: 'https://papuafootballacademy.com',
      },
      {
        name: 'Sport Tournament Management System',
        link: 'https://unileague.id',
      },
  ...
  },
  {
    ...
    reflection:
      'Worked as a frontend developer focused on refactoring and improving an internal application for PLN Enjenering. Learned to enhance code quality and user experience by applying modular and responsive design principles using Vue.js and Tailwind CSS.',
    responsibilities: [
    ...
    projects: [{ name: 'Office Management System', link: null }],
  ...
  },
  {
    ...
    reflection:
      'Worked remotely as a freelance web developer, collaborating directly with clients to deliver tailored website solutions. Focused on creating user-friendly designs and ensuring smooth deployment using WordPress and Hostinger.',
    responsibilities: [
    ...
    projects: [
      {
        name: 'Design and Development of a Landing Page for a Digital Brand',
        link: 'https://ptuh-landing.vercel.app/haramain',
      },
    ],
  ...
  },
  {
    ...
    reflection:
      'Learned to manage digital wallet systems and build a booking system. Focused on creating clean and flexible data. Got first experience with deployment and basic troubleshooting on GCP.',
    responsibilities: [
    ...
    projects: [
      {
        name: 'Digital Wallet APIs',
        link: 'https://instagram.com/halobelanja.com_official',
      },
      {
        name: 'Booking System for Attraction Rides APIs',
        link: 'https://instagram.com/bigs_indonesia',
      },
    ],
  ...
  },
  {
    ...
    reflection:
      'Worked on building a visa application backend system handling sensitive user data and real-world scenarios. Gained experience in cloud development by using Firebase Cloud Functions to automate processes and improve system scalability.',
    responsibilities: [
    ...
    projects: [
      {
        name: 'Visa Application Platform APIs',
        link: 'https://instagram.com/doortoid',
      },
    ],
  ...
  },
  {
    ...
    reflection:
      'Learned how to develop and optimize backend APIs tailored for an e-commerce platform serving fishermen. Gained experience improving system performance and ensuring reliability in a real-world environment.',
    responsibilities: [
